...
// Objetos
const mercuriObject = new NEObject(2, "Mercury", 4880, 0, 47.87 * 1000, 15, 'mercury.jpg', 7.0);
const venusObject = new NEObject(3, "Venus", 12104, 0, 35.02 * 1000, 20, 'venus.jpg', 3.39);
export const earthObject = new NEObject(4, 'Earth', 12756, 0, 29.78 * 1000, 25, 'earth.jpg', 0.0);
const moonObject = new NEObject(5, "Moon", 3474, 0, 29.78 * 1000, 27, 'moon.jpg', 0.0);
const marteObject = new NEObject(6, "Mars", 6779, 0, 24.077 * 1000, 40, 'mars.jpg', 25.19);
const jupiterObject = new NEObject(7, "Jupiter", 139820, 0, 13.07 * 1000, 60, 'jupiter.jpg', 3.13);
const saturnoObject = new NEObject(8, "Saturn", 116460, 0, 9.69 * 1000, 90, 'saturn.jpg', 26.73);
const uranoObject = new NEObject(9, "Uranus", 50724, 0, 6.81 * 1000, 130, 'uranus.jpg', 0.77);
const netunoObject = new NEObject(10, "Neptune", 49244, 0, 5.43 * 1000, 160, 'neptune.jpg', 1.76);
